...
public class RenamingBoundVarTest {
  ...
  public void simpleRenamingTest() {
    ...
    bound.add(x);
    Expression<Boolean> q = QuantifierExpression.create(Quantifier.FORALL, bound, ExpressionUtil.and(e1,e2));
  ...
  public void nestedRenamingTest2() {
    List<Variable<?>> bound = new ArrayList<>();
    bound.add(x);
    Expression<Boolean> q = ExpressionUtil.or(e1, PropositionalCompound.create(
        QuantifierExpression.create(Quantifier.FORALL, bound, e1),
        LogicalOperator.AND,
  ...
  public void nestedRenamingTest3() {
    List<Variable<?>> bound = new ArrayList<>();
    bound.add(x);
    Expression<Boolean> q = ExpressionUtil.or(ExpressionUtil.and(
        QuantifierExpression.create(Quantifier.FORALL, bound, e1)),
  ...
  public void freeVarsTest() {
    List<Variable<?>> bound = new ArrayList<>();
    bound.add(x);
    Expression<Boolean> q = ExpressionUtil.or(e1, ExpressionUtil.and(
        QuantifierExpression.create(Quantifier.FORALL, bound, e1)),
