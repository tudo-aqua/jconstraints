...
public class DisjunctionCreatorTest {
  ...
  public void conjunctionTest7(){
    ...
    Expression expected = PropositionalCompound.create(ExpressionUtil.and(e3, e4), LogicalOperator.OR, ExpressionUtil.and(e4, e3));

    Expression<Boolean> simpleDnf = (Expression<Boolean>) conjunction7.accept(DisjunctionCreatorVisitor.getInstance(), null);
  ...
  public void conjunctionTest8(){
    ...
    Expression<Boolean> simpleDnf = (Expression<Boolean>) conjunction8.accept(DisjunctionCreatorVisitor.getInstance(), null);
  ...
  public void nestedConjunctionTest(){
    Expression<Boolean> simpleDnf = (Expression<Boolean>) nestedConjunction.accept(DisjunctionCreatorVisitor.getInstance(), null);
  ...
  public void andTest(){
    ...
    Expression<Boolean> simpleDnf = (Expression<Boolean>) and.accept(DisjunctionCreatorVisitor.getInstance(), null);
  ...
  public void nestedTest1(){
    Expression nested = PropositionalCompound.create(
        ...
        PropositionalCompound.create(
            ...
            LogicalOperator.AND,
            PropositionalCompound.create(e3, LogicalOperator.OR, e4)));
    Expression<Boolean> simpleDnf = (Expression<Boolean>) nested.accept(DisjunctionCreatorVisitor.getInstance(), null);
    Expression<Boolean> dnf = NormalizationUtil.createDNF(nested);

    Expression expected =
        PropositionalCompound.create(
            PropositionalCompound.create(e3, LogicalOperator.OR, PropositionalCompound.create(
                e3,
                LogicalOperator.AND,
                e4)),
        LogicalOperator.OR,
  ...
  public void nestedTest2(){
    ...
    Expression expected = ExpressionUtil.or(ExpressionUtil.or(b1, ExpressionUtil.and(b1, b2)),
        ExpressionUtil.or(ExpressionUtil.and(b2, b1), ExpressionUtil.and(b2, b1)));

    Expression<Boolean> simpleDnf = (Expression<Boolean>) nested2.accept(DisjunctionCreatorVisitor.getInstance(), null);
  ...
  public void nestedTest3(){
    ...
    Expression<Boolean> simpleDnf = (Expression<Boolean>) nested3.accept(DisjunctionCreatorVisitor.getInstance(), null);
  ...
  public void nestedTest4(){
    ...
    Expression<Boolean> simpleDnf = (Expression<Boolean>) nested4.accept(DisjunctionCreatorVisitor.getInstance(), null);
