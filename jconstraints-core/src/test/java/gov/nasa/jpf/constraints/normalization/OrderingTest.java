...
public class OrderingTest {
  ...
  public void orderingTest2() {
    ...
    Expression<Boolean> expected =
        NumericBooleanExpression.create(zOrdered, NumericComparator.GE, c1);
  ...
  public void orderingTest3() {
    Expression<Boolean> ordered =
        NormalizationUtil.orderProblem(
            NumericBooleanExpression.create(x, NumericComparator.GE, c1));
  ...
  public void orderingTest4() {
    ...
    Expression<Boolean> expected =
        PropositionalCompound.create(
            NumericBooleanExpression.create(x, NumericComparator.LE, c1), LogicalOperator.AND, e4);
  ...
  public void orderingTest5() {
    ...
    Expression<Boolean> expected =
        PropositionalCompound.create(
            NumericBooleanExpression.create(x, NumericComparator.NE, c1), LogicalOperator.OR, e2);
  ...
  public void orderingTest6() {
    ...
    Expression<Boolean> expected =
        PropositionalCompound.create(e1ordered, LogicalOperator.AND, e1ordered);
  ...
  public void orderingTest10() {
    Expression<Boolean> ordered =
        NormalizationUtil.orderProblem(
            NumericBooleanExpression.create(a, NumericComparator.GE, c1));
  ...
  public void orderingTest11() {
    ...
    Expression<Boolean> expected =
        NumericBooleanExpression.create(zOrdered, NumericComparator.LT, c1);
  ...
  public void orderingTest12() {
    Expression<Boolean> ordered =
        NormalizationUtil.orderProblem(
            NumericBooleanExpression.create(zOrdered, NumericComparator.LE, c1));
    Expression<Boolean> expected =
        NumericBooleanExpression.create(zOrdered, NumericComparator.LE, c1);
