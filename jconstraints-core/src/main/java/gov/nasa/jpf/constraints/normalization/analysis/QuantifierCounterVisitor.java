...
public class QuantifierCounterVisitor extends AbstractExpressionVisitor<Integer, Void> {
  ...
  private final int countQuantifiers(Expression<?>... children) {
  ...
  public Integer visit(QuantifierExpression q, Void data) {
    return 1 + countQuantifiers(q.getChildren());
  }

  @Override
  protected <E> Integer defaultVisit(Expression<E> expression, Void data) {
    return countQuantifiers(expression.getChildren());
  }

  @Override
  public Integer visit(LetExpression let, Void data) {
    return countQuantifiers(let.flattenLetExpression());
  }
