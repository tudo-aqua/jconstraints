...
public abstract class AbstractExpression<E> extends Expression<E> {
  ...
  protected static <E> Expression<E>[] requireAs(Expression<?>[] expressions, Type<E> type) {
    for (int i = 0; i < expressions.length; i++) expressions[i].requireAs(type);
