...
public class TanProperties implements FunctionProperties {
  ...
  public static final Function TAN_LOOKUP =
      new UnaryDoubleFunction("tan_lookup") {
        @Override
  ...
  public static final Function TAN_PI =
      new UnaryDoubleFunction("tan_pi") {
        @Override
        protected double doEvaluate(double value) {
          throw new UnsupportedOperationException("Not supported yet.");
        }
  ...
  private Expression<Boolean> tanPi() {
    ...
    return forall(eq(fexpr(TAN_PI, arg), ite(ifCond, thenExpr, elseExpr)), arg);
  }
  ...
  private Expression<Boolean> tan() {
    ...
    return forall(eq(fexpr(MathFunctions.TAN, arg), ite(ifCond, thenExpr, elseExpr)), arg);
  }
