...
public abstract class UnaryDoubleFunction extends Function<Double> {

  public UnaryDoubleFunction(String name) {
    super(name, BuiltinTypes.DOUBLE, BuiltinTypes.DOUBLE);
  }
  ...
  protected abstract double doEvaluate(double value);
}
