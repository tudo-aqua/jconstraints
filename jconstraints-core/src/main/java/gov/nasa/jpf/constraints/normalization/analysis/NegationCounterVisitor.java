...
public class NegationCounterVisitor extends AbstractExpressionVisitor<Integer, Void> {
  ...
  private final int countNegations(Expression<?>... children) {
  ...
  @Override
  public Integer visit(Negation n, Void data) {
    return 1 + countNegations(n.getChildren());
  }

  @Override
  public Integer visit(QuantifierExpression q, Void data) {
    return countNegations(q.getBody());
  }

  @Override
  protected <E> Integer defaultVisit(Expression<E> expression, Void data) {
    return countNegations(expression.getChildren());
  }

  @Override
  public Integer visit(LetExpression let, Void data) {
    return countNegations(let.flattenLetExpression());
  }
