...
public class ExplicitCastExpression<F, E> extends AbstractExpression<E> {

  public static <F, E> ExplicitCastExpression<F, E> create(Expression<F> casted, Type<E> toType, boolean fromSigned) {
    CastOperation<? super F, ? extends E> castOp = toType.cast(casted.getType());
    return new ExplicitCastExpression<F, E>(casted, toType, castOp, fromSigned);
  }

  public static <F, E> ExplicitCastExpression<F, E> create(
      Expression<F> casted, Type<E> toType, CastOperation<? super F, ? extends E> castOp, boolean fromSigned) {
    return new ExplicitCastExpression<F, E>(casted, toType, castOp, fromSigned);
  }
  ...
  private final boolean fromSigned;

  public ExplicitCastExpression(Expression<F> casted, Type<E> toType, CastOperation<? super F, ? extends E> castOp, boolean fromSigned) {
    this.casted = casted;
    this.toType = toType;
    this.castOp = castOp;
    this.fromSigned = fromSigned;
  }
  ...
  public boolean getFromSigned() {
    return this.fromSigned;
  }
  ...
  public Expression<E> duplicate(Expression<?>[] newChildren) {
    ...
    if (newCasted == casted) return this;
  ...
  public int hashCode() {
    ...
    result = prime * result + (fromSigned ? 0 : 1);
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    ExplicitCastExpression<?, ?> other = (ExplicitCastExpression<?, ?>) obj;
    if (castOp == null) {
      if (other.castOp != null) return false;
    } else if (!castOp.equals(other.castOp)) return false;
    if (casted == null) {
      if (other.casted != null) return false;
    } else if (!casted.equals(other.casted)) return false;
    if (toType == null) {
