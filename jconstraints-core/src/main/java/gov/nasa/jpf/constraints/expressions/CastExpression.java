...
public class CastExpression<F, E> extends AbstractExpression<E> {
  ...
  public static <F, E> CastExpression<F, E> create(Expression<F> casted, Type<E> toType) {
    CastOperation<? super F, ? extends E> castOp = toType.cast(casted.getType());
    return new CastExpression<F, E>(casted, toType, castOp);
  }

  public static <F, E> CastExpression<F, E> create(
      Expression<F> casted, Type<E> toType, CastOperation<? super F, ? extends E> castOp) {
    return new CastExpression<F, E>(casted, toType, castOp);
  }
