...
final class AddPrefixVisitor extends DuplicatingVisitor<String> {

  public static final AddPrefixVisitor INSTANCE = new AddPrefixVisitor();

  /* (non-Javadoc)
   * @see gov.nasa.jpf.constraints.api.AbstractExpressionVisitor#visit(gov.nasa.jpf.constraints.api.Variable, java.lang.Object)
   */
  @Override
  public <E> Expression<?> visit(Variable<E> v, String prefix) {
    return Variable.create(v.getType(), prefix + v.getName());
  }
