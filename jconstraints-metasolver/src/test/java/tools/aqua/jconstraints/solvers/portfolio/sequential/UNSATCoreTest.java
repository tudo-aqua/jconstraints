...
public class UNSATCoreTest extends AbstractTest {
  ...
  public void example3Test() throws IOException, SMTLIBParserException {
    ...
    SolverContext ctx = unsatCoreSolver.createContext();
    String problem =
        "(set-logic QF_S)(declare-fun var0 () String)(declare-fun var1 () String)(declare-fun var2"
            ...
            + " Bool)(assert (str.prefixof var4 \"m^deXxv^!\\\\\"))(assert (str.prefixof"
            + " (str.substr (str.at var5 var7) (str.indexof var3 var1 var6) (str.indexof var2 var0"
            + " 8)) (str.substr (str.replace var3 var1 \"dO+b\"\"1S|!*\") (str.indexof var1 var3"
            + " var6) (str.indexof var3 var1 var8))))(assert (> (str.len var4) (str.indexof var2"
            + " \"U}>Ub)`),%\" var8)))(assert (> (str.indexof var3 var2 var11) (str.indexof var3"
            + " var5 var8)))(assert (>= (str.indexof var4 var4 var8) (str.indexof var5 var1"
            + " var9)))(assert (not (str.in.re (str.replace var3 var3 var3) (re.*"
            + " re.allchar))))(assert (str.contains (str.++ \"VF}W?d6;6>\" \"VF}W?d6;6>\")"
            + " (str.substr var0 var7 var7)))(check-sat)";
    SMTProblem pProblem = SMTLIBParser.parseSMTProgram(problem);
    ctx.add(pProblem.getAllAssertionsAsConjunction());
