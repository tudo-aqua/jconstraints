...
package tools.aqua.jconstraints.benchmarktest;
...
public class Z3Benchmark {
  private static NativeZ3SolverProvider provider;
  private static ConstraintSolver solver;

  @BeforeAll
  public static void init() {
    provider = new NativeZ3SolverProvider();
